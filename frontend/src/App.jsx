                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center gap-4 pt-4">
                    <button
                      ...
                      className="px-6 py-3 rounded-xl bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 text-sm font-medium transition-colors shadow-sm"
                    >
                      Start New Optimization
                    </button>
                    <button
                      onClick={() => handleBenchmark(location.state?.answers)}
                      className="px-6 py-3 rounded-xl bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 text-sm font-medium transition-colors flex items-center gap-2 shadow-sm"
                    >
